      ...
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-12">
          <div className="relative h-64 md:h-80 rounded-lg overflow-hidden shadow-lg">
            <Image src="/assets/lakshmipuja-473705d3.png" alt="Lakshmi Puja 2025" fill className="w-full h-full object-cover" priority />
          </div>
          <div className="space-y-4">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Invoking the Goddess of Prosperity</h2>
        ...
        <Card className="border-gray-200 mb-8">
          <CardContent className="p-8">
            <h3 className="text-xl font-bold text-gray-900 mb-6">Kojagari Lakshmi Puja Schedule</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <Card className="border-gray-200">
            <CardContent className="p-8">
              <h3 className="text-lg font-bold text-gray-900 mb-4">What Makes Lakshmi Puja at Kallol Unique</h3>
          ...
          <Card className="border-gray-200">
            <CardContent className="p-8">
              <h3 className="text-lg font-bold text-gray-900 mb-4">Be a Part of the Celebration</h3>
