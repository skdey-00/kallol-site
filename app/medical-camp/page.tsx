    ...
    <main className="min-h-screen pb-16 bg-gray-50">
      ...
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          <Image src="/assets/PHOTO-2025-08-04-21-57-53-20108055.png" alt="Medical Camp" fill className="w-full rounded-lg shadow-lg" priority />
          <Image src="/assets/PHOTO-2025-08-04-21-57-53-1-1-b22ff382.png" alt="Medical Camp" fill className="w-full rounded-lg shadow-lg" priority />
        </div>

        <Card className="border-gray-200">
          <CardContent className="p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Medical Camp at Kallol - March 2025</h2>
