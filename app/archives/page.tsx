...
// Past-events archive. Sources only dated events already recorded on the
// public Google Calendar (the committee-published calendar record) —
...
export default async function ArchivesPage() {
  ...
  // "Today" in IST so an event on today's date still counts as past only
  // once the day has actually turned over in Mumbai
