      ...
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-12">
          <div className="relative h-64 md:h-96 rounded-lg overflow-hidden shadow-lg">
            <Image src="/assets/5B8A0782-1-2a544d2e.webp" alt="Kallol Kali Mandir" fill className="w-full h-full object-cover" priority />
          </div>
          <div className="space-y-4">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900">A Sacred Abode of Shakti</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <Card className="border-gray-200">
            <CardContent className="p-8">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Amavasya Puja - A Divine Gathering</h3>
          ...
          <Card className="border-gray-200">
            <CardContent className="p-8">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Daily Offerings &amp; Online Puja Booking</h3>
        ...
        <Card className="border-gray-200 bg-gradient-to-r from-kallol-50 to-gray-50">
          <CardContent className="p-8 md:p-12">
            <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">Why Kallol Kali Mandir is Special</h3>
            ...
            <p className="text-center text-gray-900 font-semibold mt-4">Visit. Worship. Belong.</p>
