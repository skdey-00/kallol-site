...
/**
 * Server wrapper: pulls the next Amavasya from the public Google Calendar
 * (via getEvents()) and hands it to the client view, whose Amavasya card
 * carries the live countdown.
 */
