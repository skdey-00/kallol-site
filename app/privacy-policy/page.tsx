        ...
        <div className="max-w-4xl mx-auto">
          <Card className="border-gray-200">
            <CardContent className="p-8 md:p-12 space-y-6">
              <div>
                <h2 className="text-xl font-bold text-[#44233b] mb-3">Welcome</h2>
              ...
              <div>
                <h2 className="text-xl font-bold text-[#44233b] mb-3">Information Collection</h2>
                <p className="text-gray-700 leading-relaxed text-justify">
              ...
              <div>
                <h2 className="text-xl font-bold text-[#44233b] mb-3">Use of Information</h2>
                <p className="text-gray-700 leading-relaxed text-justify">
              ...
              <div>
                <h2 className="text-xl font-bold text-[#44233b] mb-3">Data Security</h2>
                <p className="text-gray-700 leading-relaxed text-justify">
              ...
              <div>
                <h2 className="text-xl font-bold text-[#44233b] mb-3">Contact Us</h2>
                <p className="text-gray-700 leading-relaxed text-justify">
