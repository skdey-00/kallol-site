      ...
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-12">
          <div className="relative rounded-lg overflow-hidden shadow-lg" style={{ aspectRatio: "1600 / 583" }}>
            <img src="/assets/Frame-150-9cd8eeb5.webp" alt="Kali Puja at Kallol" className="w-full h-full object-cover" />
          </div>
          <div className="space-y-4">
            <h2 className="text-2xl md:text-3xl font-bold text-kallol-800">Mahakali Puja: Invoking the Fierce Divine Mother</h2>
        ...
        <Card className="border-gray-200 mb-8">
          <CardContent className="p-8">
            <h3 className="text-xl font-bold text-kallol-800 mb-6">Mahakali Puja Schedule</h3>
