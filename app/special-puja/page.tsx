    ...
    <main className="min-h-screen pb-16 bg-gray-50">
      ...
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <Card className="border-gray-200 overflow-hidden">
            <div className="relative h-52">
              <Image src="/assets/SpecialPuja-3da3ae1b.png" alt="Special Puja" fill className="w-full h-full object-cover" priority />
            </div>
            <CardContent className="p-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Shree Shree Satyanarayan Puja</h3>
          ...
          <Card className="border-gray-200 overflow-hidden">
            <div className="relative h-52">
              <Image src="/assets/kali-mandir-banner1-dc6a1673.png" alt="Shanidev Puja" fill className="w-full h-full object-cover" priority />
            </div>
            <CardContent className="p-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Shree Shree Shanidev Puja</h3>
              <p className="text-gray-700 leading-relaxed">
        ...
        <Card className="border-gray-200 mt-8">
          <CardContent className="p-8">
            <h3 className="text-xl font-bold text-gray-900 mb-6">Other Pujas Organized at Kallol Kali Temple</h3>
