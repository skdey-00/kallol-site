...
const nextConfig = {
  ...
  async redirects() {
    // Year-specific puja URLs (2025, and the brief 2026 rename) map to the
    // evergreen routes, which now carry each year's current schedule.
    ...
    return [
      ...
      { source: '/amavasya-puja-2026', destination: '/amavasya-puja', permanent: true },
      { source: '/durga-puja-2026', destination: '/durga-puja', permanent: true },
      { source: '/kali-puja-2026', destination: '/kali-puja', permanent: true },
      { source: '/lakshmi-puja-2026', destination: '/lakshmi-puja', permanent: true },
      { source: '/saraswati-puja-2026', destination: '/saraswati-puja', permanent: true },
