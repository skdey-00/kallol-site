...
export function PageBanner({ title, subtitle }: { title: string; subtitle?: string }) {
  return (
    <motion.div
      ...
      className="relative min-h-[235px] flex items-center justify-center bg-kallol-700 pt-20"
    >
      <div className="relative z-10 text-center px-4 py-10">
        ...
        {subtitle && <p className="text-gray-200 mt-3 text-base md:text-lg max-w-2xl">{subtitle}</p>}
      </div>
    </motion.div>
  )
}
