...
export const pujaDonations: PujaDonationCategory[] = [
  {
    ...
    items: [
      { purpose: "Saptami: Spl. Puja", category: "Durga Puja", amount: 2000, date: "2025-10-08" },
      { purpose: "Saptami: Evening Puja", category: "Durga Puja", amount: 2000, date: "2025-10-08" },
      { purpose: "Ashtami: Spl. Puja", category: "Durga Puja", amount: 2000, date: "2025-10-09" },
      { purpose: "Ashtami: Evening Puja", category: "Durga Puja", amount: 2000, date: "2025-10-09" },
      { purpose: "Navami: Spl. Puja", category: "Durga Puja", amount: 2000, date: "2025-10-10" },
      { purpose: "Navami: Evening Puja", category: "Durga Puja", amount: 2000, date: "2025-10-10" },
      { purpose: "Sandhi Puja", category: "Durga Puja", amount: 21000, date: "2025-10-09" },
    ],
    offerings: [
